...
var GridUtils = (function() {
     ...
     * @param {string} gridId - Grid selector (e.g., "#buildingsGrid")
     * @param {string} apiEndpoint - API base path (e.g., "/api/building")
     ...
     * @param {string} entityName - Name of entity for error messages (e.g., "buildings")
